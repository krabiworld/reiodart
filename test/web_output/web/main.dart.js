...
i=t.S
l=t.gw
j=n.n(j.T(A.ay([1,A.aq("Reio Dart Framework 0.2.0").K(0,r)],i,l)))
n=$.cZ()
...
k.I("Examples")
j.a="p"
return n.n(k.O(0,"examples")).aq($.eY()).n(A.f7()).aq($.eZ()).n(A.M(null).O(0,"footer").n(A.M("GitHub").E(A.d(["footer-title"],s)).n(A.E(p).T(A.ay([1,A.aq("Repository").K(0,r)],i,l))).n(A.E(p).T(A.ay([1,A.aq("Documentation").K(0,"https://github.com/MineEjo/reiodart/wiki")],i,l)))).n(A.M("Pub.dev").E(A.d(["footer-title"],s)).n(A.E(p).T(A.ay([1,A.aq("Package").K(0,"https://pub.dev/packages/reio")],i,l))).n(A.E(p).T(A.ay([1,A.aq("API reference").K(0,"https://pub.dev/documentation/reio/latest/")],i,l))))).n(A.E("\xa9 2023 MineEjo").O(0,"footer-copy"))},
$S:3}
A.ev.prototype={
